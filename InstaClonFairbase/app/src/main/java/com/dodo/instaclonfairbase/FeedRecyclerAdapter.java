package com.dodo.instaclonfairbase;
...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> {
    ...
    class PostHolder extends RecyclerView.ViewHolder{
        ...
        public PostHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.recyclerViewRowuserImageView);
            userEmailText = itemView.findViewById(R.id.recyclerViewRowuserEmailText);
            commentText = itemView.findViewById(R.id.recyclerViewRowuserCommentText);
